...
?>
	...
	<main id="primary" class="site-main">
		...
		<section class="error-404 not-found pt-5 pb-5 interior-page-content dark">
			<div class="container text-center d-flex justify-content-center pt-5 pb-5">
				<div class="row">
					<div class="col">
					<header class="page-header">
				<h2 class="page-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', '_s' ); ?></h2>
			</header><!-- .page-header -->

			<div class="page-content">
				<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', '_s' ); ?></p>

				<!-- Uncomment below lines if the website contains a blog -->

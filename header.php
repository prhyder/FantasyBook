...
<div id="page" class="site">
	...
	<header>
		<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
			<div class="container">
				<a class="navbar-brand" aria-label="Scroll to Page Top" href="#page-top"><img alt="CJ Kinsley Author Logo" src="<?php echo get_template_directory_uri(); ?>/images/Author-Logo.png"></a>
				...
				<div class="navbar-collapse collapse" id="navbarResponsive" >
					...
					<a href="#subscribe" class="action-button mobile btn-primary btn text-center mx-auto">Get Free Chapter</a>
				</div>
				<a href="#subscribe" class="action-button desktop btn-primary btn text-center mx-auto">Get Free Chapter</a>
			</div>
		</nav> 
	</header>
